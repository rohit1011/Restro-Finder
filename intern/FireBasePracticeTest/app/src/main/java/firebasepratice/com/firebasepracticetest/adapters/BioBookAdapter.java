...
public class BioBookAdapter extends RecyclerView.Adapter<BioBookAdapter.BookHolder> {
    private Context mContext;
    private List<BookObject> bookObjects= new ArrayList<>();

    public BioBookAdapter(Context mContext) {
        this.mContext = mContext;
    }


    public void setBioBookObjects(BookObject bookObject) {
