...
public class MiscellaneousBookAdapter extends RecyclerView.Adapter<MiscellaneousBookAdapter.BookHolder> {
    private Context mContext;
    private List<BookObject> bookObjects= new ArrayList<>();

    public MiscellaneousBookAdapter(Context mContext) {
        this.mContext = mContext;
    }


    public void setMiscellaneousBook(BookObject bookObject) {
